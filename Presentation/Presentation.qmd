...
<!-- # ```{r echo= FALSE, warning = FALSE} --> <!-- # source("../R_scripts/Season_data/log_graphs.R")  --> <!-- # combined_log_plot <- ggarrange(log_hosp_plot1718 , log_hosp_plot1819, --> <!-- #                                log_hosp_plot1920, log_hosp_plot2223, --> <!-- #                                ncol = 2, nrow = 2,  --> <!-- #                                heights = c(2, 2,2,2),  --> <!-- #                                binwidth = 1, --> <!-- #                                common.legend = T, legend="bottom") --> <!-- # combined_log_plot --> <!-- # ``` --> \# \##
...
No observable: - temporal relationship between data sources - relationship between scale of peaks - changes in reporting patterns post-COVID
