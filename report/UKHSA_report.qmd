...
Secondly we believe there could be changes in reporting patterns for
Influenza-Like-Illnesses (ILI) post COVID. As children have more
interactions, we would expect both a larger and earlier peak as compared
with that of the older population. Finally, we expect the
...
studied, the complex nature and changes from season to season mean it is
...
sources, there is a lag in GP cases among different age groups. There is
also a noticeable difference also in the rate of spread reported between
