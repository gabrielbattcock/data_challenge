...
=======
In the analysis, log graphs were plotted and a linear model was fitted to
...
**Figure 5 and 6**: Lab-confirmed cases of influenza, stratified by influenza
...
The data for 2018-19 season only recorded two types of influenza: A (unknown) and B
...
caused only a minor burden in comparison to A (H3).
...
For the 2022-23 season we can observe
...
interesting comparisons would be with the work by \[1\] studying the
effect of the COVID-19 pandemic on ILI-related hospitalization and
mortality in children \[1\]. The main findings conclude there was a
...
\[2\]. It is suspected that during that period, ILI was under-reported
...
of COVID-19 \[3\]. Another possible explanation is the change in contact
...
-   Data extraction and cleaning
    ...
    -   GB - 2014-2021 swab data (using provided script), 2017-18
        hospitalisations (with Szymon)
    -   AC -
    -   SJ -
...
-   Scripting
    ...
    -   GB - season 2017-2022, log_graphs, age_strat, hospitalisation
        plots
    -   AC -
    -   SJ -
