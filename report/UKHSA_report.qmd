...
*Hypothesis:* We suspect that there is a temporal relationship between one source of surveillance and another. Additionally, we suspect there is also a relationship between the scale of the peaks between sources of influenza data. Secondly we believe there could be changes in reporting patterns for Influenza-Like-Illnesses (ILI) post COVID. As children have more interactions, we would expect both a larger and earlier peak as compared with that of the older population. Finally, we expect the hospitalisation rate to change depending on which influenza strain is dominant during the season.

## Methods

### Data sources and extraction

Influenza case data have been extracted from various places. Firstly, primary care data was reported by the Royal College of General Practitioners (RCGP) Research and Surveillance Centre communicable and respiratory disease reports. Cases of Influenza Like Illnesses (ILI) that present in participating GP practices are collected and reported for England and Wales [@RCGP].
...
Essential interpretation based on key findings --GB
...
Data extraction -
  GB - 2014-2021 swab data (using provided script), 2017-18 hospitalisations (with Szymon)
  AC - 
  SJ -
  HL - 
  
R-scripts -
  GB - season 2017-2022, log_graphs, age_strat, hospitalisation plots
  AC - 
  SJ -
  HL - 
  
Pres/Report
  All shared, Jack (HL) made the graphics. 
