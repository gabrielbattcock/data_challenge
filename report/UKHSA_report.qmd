...
variables are equal in length. As seen in Qin *et al.* 2019 [@Qin2019] The measurement of cross-correlation between pairs of variables should be as follows. One variable, denoted
$x_{t}$, is pinned to the present. A lag of positive integer $k$ is
applied to the other variable $y$ to generate $y_{t},\; y_{t+1},\;\ldots y_{t+k}$ . For a given influenza season, Spearman's test is run
...
epidemic, and post-epidemic periods [@Vega2013]. Within each, a given number of data
...
From cross-correlation test, we find out that 
...
Few studies have been done on this topic, and none on UK data. However, there are several sources which try to understand the
...
Throughout this project, we have not attempted, nor it is part of the agenda to forecast flu. While there exists machine learning methods (e.g. ARIMA) to make reasonable forecasts, in-depth understanding of infection dynamics is needed to build a suitable *A Priori* model. 

Considering all the above, we can state that there is room for improvement with further research on this topic. 
...
- Data extraction and cleaning
  - GB - 2014-2021 swab data (using provided script),
    2017-18 hospitalisations (with Szymon) 
  - AC - 
  - SJ - 
  - HL - Mortality and Vaccine
- Scripting
  - GB - season 2017-2022, log_graphs, age_strat,
    hospitalisation plots 
  - AC - 
  - SJ - 
  - HL - cross-correlation, 
- Visualisation
...
- Writing-Up
  ...
  - AC - 
  - SJ - 
  - HL - Abstract, Methods-correlation, Methods-MEM, Discussion-limitations
