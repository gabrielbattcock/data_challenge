...
log_hosp <- log10(hospital$`Hospital admission (rate)`)
log_week <- log10(week)
log_gp <- log10(gp)
log_swab <- log10(swab)
...
log_hosp <- log10(hospital18$`2018-19 Hospital admission (rate)`)
log_week <- log10(week)
log_gp <- log10(gp18)
log_swab <- log10(swab18)
log_season <- data.frame(week, log_hosp = log_hosp, log_gp, log_swab)
...
log_hosp <- log10(hospital17)
log_week <- log10(week)
log_gp <- log10(gp17)
log_swab <- log10(swab17)
log_season <- data.frame(week, log_hosp = log_hosp, log_gp, log_swab)
